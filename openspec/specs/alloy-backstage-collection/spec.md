...
Backstage backend metrics exported via `@opentelemetry/exporter-metrics-otlp-http` SHALL be received by Alloy and available in Prometheus within 60 seconds.
