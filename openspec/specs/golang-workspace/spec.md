...
The `go.work` file SHALL include all Go modules under `src/` as `use` directives, including `src/staccato-toolkit/cli`, `src/staccato-toolkit/server`, `src/staccato-toolkit/core`, and `src/ops/workloads`.
...
- **THEN** it SHALL contain `use` directives for all four modules: `./src/staccato-toolkit/cli`, `./src/staccato-toolkit/server`, `./src/staccato-toolkit/core`, `./src/ops/workloads`
