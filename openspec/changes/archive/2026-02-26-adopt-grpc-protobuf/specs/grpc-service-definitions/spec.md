---
td-board: adopt-grpc-protobuf-grpc-service-definitions
td-issue: td-cd60d3
---

# Specification: gRPC Service Definitions

## Overview

This spec defines patterns and conventions for defining gRPC services using Protocol Buffers. It covers proto file organization, message structure conventions, service boundaries, and when to use gRPC vs. other RPC patterns.
