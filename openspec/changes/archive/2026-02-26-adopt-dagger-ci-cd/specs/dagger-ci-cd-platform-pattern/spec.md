---
td-board: adopt-dagger-ci-cd-dagger-ci-cd-platform-pattern
td-issue: td-eaa0d2
---

# Specification: dagger-ci-cd-platform-pattern

## Overview

Defines the platform pattern for using Dagger CI/CD in multi-stage pipelines, including orchestration, caching coordination, cross-module task dependencies, secrets handling, and differences between local development and CI execution.
