...
const results = mlRankingEnabled ? await mlRanker.rank(query, candidates) : candidates; // fallback to relevance order
```
...
- _Continuous Delivery_, Humble & Farley — Chapter 14: Advanced Version Control
- _Release It!_, Nygard — Chapter 9
