...
Flux authenticates to Harbor using the declarative `flux-system/harbor-oci-credentials`
`kubernetes.io/dockerconfigjson` Secret rendered by the `st-workloads` addon.
