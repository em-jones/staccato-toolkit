...
CREATE TABLE `entity_relations` (
	...
	`created_at` integer NOT NULL,
	FOREIGN KEY (`from_entity_id`) REFERENCES `catalog_entities`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`to_entity_id`) REFERENCES `catalog_entities`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
